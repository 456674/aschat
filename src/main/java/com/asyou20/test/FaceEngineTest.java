...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "6dirDzcJPrTZLVGQdf48MZ5diyN8aW8PLGhckAszJetn";
        String sdkKey = "HBQ31drM1Fd6sRHHAkCR6ytdWpGgWhXa1UsKSPr5mDSi";


        FaceEngine faceEngine = new FaceEngine("C:\\Users\\gaojack\\Downloads\\Mongo-Blog-ant-main\\Mongo-Blog-ant-main\\aschat\\libs\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("E:\\facelogin\\aaa.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("E:\\facelogin\\ccc.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("E:\\facelogin\\ccc.jpg"));
